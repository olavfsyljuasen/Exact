...
SingleOperatorObservable_impl::SingleOperatorObservable_impl(Operator& Aop_in,string filename_in):Aop(Aop_in),filename(filename_in){}
...
CorrelationFunctionObservable_impl::CorrelationFunctionObservable_impl(Operator& Aop_in,string filename_in):Aop(Aop_in),filename(filename_in){}
